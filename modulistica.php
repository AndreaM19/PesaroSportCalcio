...
<body>
    ...
    <div class=" container-fluid">
        ...
        <div class="col-md-7 container-main">
            ...
            <p>In questa sezione del sito puoi trovare la documentazione e la modulistica per entrare a far parte della nostra associazione</p>
            <br>
            <p>
            <?php
            $queryText = "SELECT * FROM module";
            $query = queryToDB($conn, $queryText);
            while ($row = mysqli_fetch_array($query)){
                echo"<h5><span class='glyphicon glyphicon-file' aria-hidden='true'></span> ".$row['module_name']." 
                    <a href='".$row['file_path']."' target='_blank'>Scarica il modulo</a>
                    </h5>";
            }	
